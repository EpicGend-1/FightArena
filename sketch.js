...
function preload(){
    ...
    f2w = loadImage("FIGHTER2WINS.PNG")
    //Animations
...
function draw() {  
   ...
   // if (blueBeam.isTouching(fighter2) && fightState ===1){
   //     f2health -= 4
   // }
}
   ...
   if (fightState===3){
    ...
    if (fightState === 4){
        ...
        f1beamballs -=1
        //if (blueBeam.isTouching(fighter2) && fightState === 4){
        //    f2health -= 4
    //}
        fightState = 1
    ...
    if(fightState === 5){
        ...
        fighter.changeAnimation("f1f",f1KOanime)
        fightState=6
   ...
   if (fightState2===3){
    ...
    textSize(30)
    fill(255)
    if(fightState2 === 1 || fightState2 === 2 || fightState2 ===3 || fightState2 ===4 || fightState2 === 5){
     text("X",230,310)
    text("Z",80,310)
    text("C",400,310)
    text("A for left, D for right",40,400)
    text("BeamBalls Left For Fighter1 : "+ f1beamballs,40,360)
    text("H",1200,310)
    text("J",1350,310)
    text("K",1500,310)
    text("U for left, O for right",1150,400)
    text("FireBalls Left For Fighter2 : "+ fireballst,1150,360)
    text(f1health+ " HP",fighter.x,600)
    text(f2health+ " HP",fighter2.x,600)
    }
    else{
        text("Good Fight",200,400)
    }
